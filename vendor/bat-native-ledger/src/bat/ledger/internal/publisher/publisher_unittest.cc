...
class PublisherTest : public testing::Test {
 ...
 protected:
  void CreatePublisherInfoList(std::vector<type::PublisherInfoPtr>* list) {
    double prev_score;
...
TEST_F(PublisherTest, synopsisNormalizerInternal) {
  ...
  std::vector<type::PublisherInfoPtr> new_list;
  ...
  std::vector<type::PublisherInfoPtr> new_list2;
  publisher_->synopsisNormalizerInternal(
      &new_list2, &new_list, 0);
  new_list2.erase(new_list2.begin() + 4);
  std::vector<type::PublisherInfoPtr> new_list3;
  publisher_->synopsisNormalizerInternal(
      &new_list3, &new_list2, 0);
  new_list3.erase(new_list3.begin() + 5);
  std::vector<type::PublisherInfoPtr> new_list4;
  publisher_->synopsisNormalizerInternal(
      &new_list4, &new_list3, 0);
  new_list4.erase(new_list4.begin() + 6);
  std::vector<type::PublisherInfoPtr> new_list5;
  publisher_->synopsisNormalizerInternal(
